...
// Ícones por bloco (na mesma ordem de content.arquitetura.blocos)
const ICONS = [
  (
...
const { eyebrow, titulo, destaque, blocos, tagNucleo, fecho, fechoDestaque } =
  content.arquitetura;
            ...
            {blocos.map((b, i) => {
              ...
              return (
                <li key={b.step} className="relative pl-16 lg:pl-0">
                  ...
                  <h3 className="mt-4 text-base font-bold leading-snug text-cloud">
                    {b.titulo}
                  </h3>
